"""Threading-specific behavior tests for ThreadPoolRateLimiter."""

from unittest.mock import MagicMock, patch


class TestThreadPoolRateLimiter:
    """Tests that are specific to the threading backend implementation."""

    def test_dispatch_task_submits_to_executor(
        self, limiter, default_payload, func_path, task_id
    ):
        """Verify _dispatch_task submits a callable to the thread pool."""
        # Act
        with (
            patch(
    ...
    def test_dispatch_task_resolves_function_path(
        ...
        """Verify _dispatch_task uses import_string to resolve the function."""
        # Act
        with (
    ...
    def test_dispatch_task_wraps_in_lifecycle(
        ...
        """Verify _dispatch_task wraps execution in task_lifecycle context."""
        # Arrange
        ...
        with (
            ...
            # Execute the submitted wrapper to trigger lifecycle.
            submitted_fn = mock_submit.call_args[0][0]
            submitted_fn()
