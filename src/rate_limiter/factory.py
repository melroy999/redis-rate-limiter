...
from rate_limiter.registry import register_limiter
...
class CeleryRateLimiterFactory:
    ...
    def create_limiter(
            self, limiter_id, window, limit, max_concurrency, max_age=3600, force_register: bool = False
    ) -> CeleryRateLimiter:
        """
        ...
        :param force_register: Whether to forcefully overwrite
        ...
        register_limiter(limiter, force_register)
        return limiter